...
def checkImg(event):
    ...
    if fileType in imgType_list:
        ...
        cv2.imwrite(r'D:/aiImg/in' + fileName[0] + "." + fileType, img)
        print("file created:{0}".format(event.src_path), fileType, fileName)
        piliang('D:/aiImg/input', 'D:/aiImg/output')
        delete('D:/aiImg/input')
        ...
        if __name__ == "__main__":
            ...
            observer.schedule(event_handler, r"D:\aiImg\in", True)
            observer.start()
