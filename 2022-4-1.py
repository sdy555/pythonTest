...
#
# img = cv2.imread('D:/aiImg/588.jpg')  # 测试图片
# H = img.shape[0]
# W = img.shape[1]
#
...
img1 = io.imread('D:/aiImg/car1.jpg')
astro = img_as_float(img1)
# astro = astro[30:180, 150:300]

noisy = astro + 0.3 * np.random.random(astro.shape)
noisy = np.clip(noisy, 0, 1)

denoise = denoise_nl_means(noisy,6 , 7, 0.07, multichannel=True)
...
plt.show()
io.imsave('D:/aiImg/603.jpg',denoise)
