...
def plot_img_and_hist(image, axes, bins=256):
    ...
    """
    # image = io.imread('D:/aiImg/yibiao.jpg')
...
ax_img, ax_hist, ax_cdf = plot_img_and_hist(gamma_corrected, axes[:, 1])# 伽马调整
...
# prevent overlap of y-axis labels .tight_layout() :防止y轴标签重叠
fig.tight_layout()
plt.show()


# from skimage import data,io, exposure, img_as_float
# image = img_as_float(io.imread('D:/aiImg/yibiao.jpg'))
